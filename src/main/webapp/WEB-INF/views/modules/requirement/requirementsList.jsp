...
<body>
	<ul class="nav nav-tabs">
		<li class="active"><a href="${ctx}/requirement/requirements/">需求管理列表</a></li>
		<shiro:hasPermission name="requirement:requirements:edit"><li><a href="${ctx}/requirement/requirements/form">需求管理添加</a></li></shiro:hasPermission>
	</ul>
		...
		<c:forEach items="${page.list}" var="requirements">
			<tr>
				...
				<shiro:hasPermission name="requirement:requirements:edit"><td>
					...
					<a href="${ctx}/requirement/requirements/delete?id=${requirements.id}" onclick="return confirmx('确认要删除该需求管理吗？', this.href)">删除</a>
