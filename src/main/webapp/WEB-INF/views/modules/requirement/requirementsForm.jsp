...
<body>
	<ul class="nav nav-tabs">
		<li class="active"><a
			href="${ctx}/requirement/requirements/form?id=${requirements.id}">需求创建<shiro:hasPermission
					name="requirement:requirements:edit">${not empty requirements.id?'修改':'添加'}</shiro:hasPermission>
				<shiro:lacksPermission name="requirement:requirements:edit"></shiro:lacksPermission></a></li>
	</ul>
	<br />
	<form:form id="inputForm" modelAttribute="requirements"
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:select path="requirementSource" htmlEscape="false"
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:select path="requirementClassify" htmlEscape="false"
					maxlength="50" class="input-xlarge " />
			</div>
		</div>
		<div class="control-group">
			...
			<div class="controls">
				<form:select path="businessSystem" htmlEscape="false" maxlength="50"
					class="input-xlarge " />
			</div>
		</div>
		<div class="control-group">
			...
			<div class="controls">
				<form:select path="requirementEmergency" htmlEscape="false"
					maxlength="50" class="input-xlarge " />
			</div>
		</div>
		<div class="control-group">
		...
		<div class="control-group">
			<label class="control-label">问题单编号：</label>
			<div class="controls">
				<form:input path="proId" htmlEscape="false" maxlength="20"
					class="input-xlarge " />
			</div>
		</div>
		<div class="control-group">
