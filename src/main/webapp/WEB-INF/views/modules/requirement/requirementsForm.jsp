...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/requirement/requirements/">需求创建列表</a></li>
		<li class="active"><a href="${ctx}/requirement/requirements/form?id=${requirements.id}">需求创建<shiro:hasPermission name="requirement:requirements:edit">${not empty requirements.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission name="requirement:requirements:edit">查看</shiro:lacksPermission></a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="requirements" action="${ctx}/requirement/requirements/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:input path="requirementEmergency" htmlEscape="false" maxlength="50" class="input-xlarge "/>
			</div>
		</div>
		<div class="control-group">
			<label class="control-label">业务期待及意向简介：</label>
			<div class="controls">
				<form:input path="expectAndIntention" htmlEscape="false" maxlength="200" class="input-xlarge "/>
			</div>
		</div>
		<div class="control-group">
			<label class="control-label">签报号：</label>
			<div class="controls">
				<form:input path="signNo" htmlEscape="false" maxlength="100" class="input-xlarge "/>
			</div>
		</div>
		<div class="control-group">
			<label class="control-label">期望上线时间：</label>
			<div class="controls">
				<input name="expectOnline" type="text" readonly="readonly" maxlength="20" class="input-medium Wdate "
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:input path="reasonsChange" htmlEscape="false" maxlength="1000" class="input-xlarge "/>
			</div>
		</div>
		<div class="control-group">
			<label class="control-label">当前业务处理方案：</label>
			<div class="controls">
				<form:input path="currentBusiProcScenario" htmlEscape="false" maxlength="1000" class="input-xlarge "/>
			</div>
		</div>
		<div class="control-group">
			<label class="control-label">提请方：</label>
			<div class="controls">
				<form:input path="submitTo" htmlEscape="false" maxlength="50" class="input-xlarge "/>
			</div>
		</div>
		<div class="control-group">
			<label class="control-label">需求提出处室：</label>
			<div class="controls">
				<form:input path="requiremenPresentationOffice" htmlEscape="false" maxlength="50" class="input-xlarge "/>
			</div>
		</div>
		<div class="control-group">
			<label class="control-label">申请人：</label>
			<div class="controls">
				<form:input path="proposer" htmlEscape="false" maxlength="50" class="input-xlarge "/>
			</div>
		</div>
		<div class="control-group">
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:input path="requirementCauseDescription" htmlEscape="false" maxlength="500" class="input-xlarge "/>
			</div>
		</div>
		<div class="control-group">
			<label class="control-label">需求内容：</label>
			<div class="controls">
				<form:input path="requirementContent" htmlEscape="false" maxlength="500" class="input-xlarge "/>
			</div>
		</div>
		<div class="control-group">
			<label class="control-label">资料附件清单：</label>
			<div class="controls">
				<form:input path="annexList" htmlEscape="false" maxlength="500" class="input-xlarge "/>
			</div>
		</div>
		<div class="control-group">
			<label class="control-label">需求验收联系人：</label>
			<div class="controls">
				<form:input path="requirementAcceptancePerson" htmlEscape="false" maxlength="50" class="input-xlarge "/>
			</div>
		</div>
		<div class="control-group">
			<label class="control-label">联系电话：</label>
			<div class="controls">
				<form:input path="requirementAcceptancePhone" htmlEscape="false" maxlength="50" class="input-xlarge "/>
			</div>
		</div>
		<div class="control-group">
			<label class="control-label">需求状态：</label>
			<div class="controls">
				<form:input path="requirementStatus" htmlEscape="false" maxlength="20" class="input-xlarge "/>
			</div>
		</div>
		<div class="control-group">
			<label class="control-label">关联业务需求：</label>
			<div class="controls">
				<form:input path="relatedBusinessDemand" htmlEscape="false" maxlength="20" class="input-xlarge "/>
			</div>
		</div>
		<div class="control-group">
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:input path="lastUpdate" htmlEscape="false" maxlength="20" class="input-xlarge "/>
			</div>
		</div>
		<div class="control-group">
			<label class="control-label">最后更新时间：</label>
			<div class="controls">
				<input name="latUpdateTime" type="text" readonly="readonly" maxlength="20" class="input-medium Wdate "
					...
					<table id="contentTable" class="table table-striped table-bordered table-condensed">
						<thead>
							<tr>
								...
								<th>问题描述</th>
								<th>问题单编号</th>
								<shiro:hasPermission name="requirement:requirements:edit"><th width="10">&nbsp;</th></shiro:hasPermission>
							</tr>
						</thead>
						<tbody id="problemList">
						</tbody>
						<shiro:hasPermission name="requirement:requirements:edit"><tfoot>
		...
		<div class="form-actions">
			<shiro:hasPermission name="requirement:requirements:edit"><input id="btnSubmit" class="btn btn-primary" type="submit" value="保 存"/>&nbsp;</shiro:hasPermission>
